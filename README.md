...
<p align="center">
  <b>A small, calm space to check in with myself.</b><br>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Storage-localStorage-6366f1?style=flat-square" alt="localStorage"/>
  <img src="https://img.shields.io/badge/Frameworks-None-2ea44f?style=flat-square" alt="No frameworks"/>
</p>
...
```mermaid
pie showData title Share of adolescent mental disorders (UNICEF)
...
<sub>Figures are drawn from the sources above and are for context only. They are estimates that change over time, so check the linked pages for the latest numbers.</sub>
